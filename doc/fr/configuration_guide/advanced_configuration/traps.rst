...
#. Le service 'centreontrapd' transmet les informations à l'ordonnanceur ou au service 'centreon-gorgone' (pour transmettre les informations à un ordonnanceur distant) qui se charge de modifier le statut et les informations associées au service auquel est lié le trap SNMP.
